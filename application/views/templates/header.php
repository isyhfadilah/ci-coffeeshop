...
<body class="bg-stone-950 font-poppins">
    <header class="z-10 top-0 fixed w-full backdrop-blur-xl bg-stone-950 bg-opacity-50 flex justify-between py-5 px-8 items-center shadow-md sm:px-20 md:px-10 lg:px-20">
        ...
        <div class="hidden md:inline-block">
            ...
            <a href="<?= site_url('Home/login'); ?>" class="bg-transparent border-2 border-dark1 shadow-[0_0_3px_#D9D6D5] text-sm text-light py-0 px-5 rounded-full font-light capitalize lg:text-base hover:shadow-[0_0_5px_#D9D6D5]">masuk</a>
        </div>
