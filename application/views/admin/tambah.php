...
<section class="my-[30%] sm:my-[20%] md:my-[15%] lg:my-[10%] mx-[8%]">
    <div class="flex justify-center">
        <div class="bg-stone-900 px-[2%] py-[5%] rounded-xl w-2/2 sm:w-2/3 shadow-[0_0_5px_#D9D6D5]">
            <h1 class="text-center text-light pb-[5%] font-bold uppercase text-[20px]">tambah menu</h1>
            ...
            <form class="w-full" action="" method="post" enctype="multipart/form-data">
                <div class="flex flex-wrap mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-[#2a140e] border border-red-500 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" name="nama" placeholder="nama produk">
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-[#2a140e] border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" name="harga" placeholder="22000">
